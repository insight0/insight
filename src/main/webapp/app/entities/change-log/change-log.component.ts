...
export class ChangeLogComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.changeLogService
        ...
        .subscribe(
          (res: HttpResponse<IChangeLog[]>) => this.paginateChangeLogs(res.body, res.headers),
  ...
  registerChangeInChangeLogs() {
    this.eventSubscriber = this.eventManager.subscribe('changeLogListModification', response => this.reset());
  }
