...
describe('Service Tests', () => {
  describe('EmailTemplate Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new EmailTemplate('ID', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a EmailTemplate', async () => {
      ...
      it('should update a EmailTemplate', async () => {
        const returnedFromService = Object.assign(
          {
            holidayEmailTemplate: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of EmailTemplate', async () => {
        const returnedFromService = Object.assign(
          {
            holidayEmailTemplate: 'BBBBBB'
          },
      ...
      it('should delete a EmailTemplate', async () => {
