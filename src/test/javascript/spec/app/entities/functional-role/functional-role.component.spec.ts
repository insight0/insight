...
import { FunctionalRoleComponent } from 'app/entities/functional-role/functional-role.component';
...
describe('Component Tests', () => {
  describe('FunctionalRole Management Component', () => {
    let comp: FunctionalRoleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FunctionalRoleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.functionalRoles[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
